...
def MFDFA(data,scale,q,m,qindex,Adjustment,noise,figure,scale_min,scale_max,scale_res):
    ...
    scale_selector=Aux_Window("Scale Selector")
    scale_selector.add_scale("Select the value for the next regresion:",scale_min,scale_max)   
    scale_selector.start_window()
