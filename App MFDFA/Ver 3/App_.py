...
class Aux_Window():
    ...
    def valuecheck_left_delimiter(self,value):
        ...
        self.window_scale.configure(from_=newvalue)
        self.right_delimiter_scale.configure(from_=newvalue)

    def valuecheck_right_delimiter(self,value):
        newvalue=min(self.scale_delimiter_window, key=lambda x:abs(x-float(value)))
        self.right_delimiter_scale.set(newvalue)
        self.window_scale.configure(to=newvalue)
        self.left_delimiter_scale.configure(to=newvalue)
    ...
    def close_window(self):
        ...
        self.left_value=self.left_delimiter_scale.get()
        self.right_value=self.right_delimiter_scale.get()
        self.section=self.one_section
        self.window.quit()
        self.window.destroy()   
